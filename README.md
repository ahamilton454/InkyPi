...
## About InkyPi 
InkyPi is an open source, customizable E-Ink display powered by a Raspberry Pi. It keeps setup simple and flexible, so it is easy to show the content that matters most through a straightforward web interface.
...
- Open source project that makes it easy to modify, customize, and create plugins
...
After the installation completes, the script will prompt a reboot of the Raspberry Pi. Once it restarts, the display will update to show the InkyPi splash screen.
...
For more details, including instructions on how to image the microSD with Raspberry Pi OS, refer to [installation.md](./docs/installation.md). There is also [this YouTube tutorial](https://youtu.be/L5PvQj1vfC4).
...
3. Run the update script with sudo:
    ...
    ```
This process helps apply new updates, including additional dependencies, without requiring a full reinstallation.
...
## Roadmap
The InkyPi project continues to grow, with plenty of exciting features and improvements planned for the future.
...
Check out the [troubleshooting guide](./docs/troubleshooting.md). If the issue continues, it is always welcome on the [GitHub Issues](https://github.com/fatihak/InkyPi/issues) page.
...
InkyPi is maintained and developed with the help of sponsors. If the project proves useful, sponsorship helps support its continued development.
