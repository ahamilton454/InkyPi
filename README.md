# InkyPi – delightful E-Ink displays for everyday magic

<img src="./docs/images/inky_clock.jpg" />


## About InkyPi 
InkyPi is a friendly, open-source, customizable E-Ink display powered by a Raspberry Pi, designed to make it fun and effortless to show the content you care about through a simple, intuitive web interface.

**Features**:
- Natural, paper-like aesthetic with crisp, minimalist visuals that are easy on the eyes, with no glare or backlight
- Friendly web interface lets you update and configure the display from any device on your network
- Minimize distractions: no LEDs, no noise, and no notifications—just the calm content you care about
- Easy installation and configuration, perfect for beginners and makers alike who want to get started in minutes
- Open source project that invites you to modify, customize, and create your own plugins to share with the community
- Scheduled playlists to display different plugins at designated times, so your screen always feels fresh

**Plugins (and growing!)**:

- Image Upload: Instantly upload and display any image directly from your browser
- Daily Newspaper/Comic: Enjoy daily comics and front pages of major newspapers from around the world
- Clock: Beautiful, customizable clock faces for displaying the time at a glance
- AI Image/Text: Generate playful images and dynamic text from prompts using OpenAI's models
- Weather: Show current weather conditions and multi-day forecasts with a clean, customizable layout
- Calendar: Visualize your calendar from Google, Outlook, or Apple Calendar with layouts that fit your style

And many additional plugins are on the way! For documentation on building custom plugins, see [Building InkyPi Plugins](./docs/building_plugins.md).
...
After the installation is complete, the script will prompt you to reboot your Raspberry Pi. Once rebooted, the display will update to proudly show the InkyPi splash screen.
...
## Update
To keep your InkyPi fresh with the latest features and improvements, follow these steps:
...
3. Run the update script with sudo:
    ...
    ```
This process keeps everything up to date, ensuring new code changes and dependencies are applied without requiring a full reinstallation.
...
## Roadmap
The InkyPi project is constantly evolving, with lots of exciting features and improvements planned for the future.

- Even more powerful and fun plugins
- Modular layouts to mix and match plugins into the perfect dashboard
- Support for buttons with customizable action bindings
- A smoother, more polished web UI on mobile devices
...
If you are using a Pi Zero W, be aware that there are a few known issues during the installation process. See [Known Issues during Pi Zero W Installation](./docs/troubleshooting.md#known-issues-during-pi-zero-w-installation) in the troubleshooting guide for additional details and workarounds.

## Sponsoring

InkyPi is maintained and developed with the generous help of sponsors. If you enjoy the project or find it useful, consider supporting its continued development.
