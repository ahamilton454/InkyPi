...
## About InkyPi 
InkyPi is an open-source, customizable E-Ink display powered by a Raspberry Pi. Built for simplicity and flexibility, it makes it easy to display the content that matters most, with a simple web interface that keeps setup and configuration straightforward.
...
**Disclosure:** The links above are affiliate links. I may earn a commission from qualifying purchases made through them, at no extra cost to you, and that support helps maintain and develop this project.
...
After the installation is complete, the script will prompt you to reboot your Raspberry Pi. Once it restarts, the display will update to show the InkyPi splash screen.
...
For more details, including instructions on how to image your microSD with Raspberry Pi OS, refer to [installation.md](./docs/installation.md). It may also help to check out [this YouTube tutorial](https://youtu.be/L5PvQj1vfC4).
...
3. Run the update script with sudo:
    ...
    ```
This process ensures that new updates, including code changes and additional dependencies, are applied properly without requiring a full reinstallation.
...
Check out the public [trello board](https://trello.com/b/SWJYWqe4/inkypi) to explore upcoming features and vote on what feels most useful next.
