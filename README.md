...
## About InkyPi 
InkyPi is an open-source, customizable E-Ink display powered by a Raspberry Pi. Built for simplicity and flexibility, it makes it easy to display the content that matters, with a simple web interface that keeps setup and configuration straightforward.

**Features**:
- Natural paper-like aesthetic: crisp, minimalist visuals that are easy on the eyes, with no glare or backlight
- The Web Interface lets you update and configure the display from any device on your network
...
- Open source project that lets you modify, customize, and create your own plugins
...
See [the wiki](https://github.com/fatihak/InkyPi/wiki) for a welcoming list of community-maintained third-party plugins.
...
- E-Ink Display:
    ...
    - Waveshare e-Paper Displays
        ...
        - See [Waveshare e-paper displays](https://www.waveshare.com/product/raspberry-pi/displays/e-paper.htm?&aff_id=111126) or visit their [Amazon store](https://amzn.to/3HPRTEZ) for additional models. Note that some models, such as the IT8951 based displays, are not supported. See the later section on [Waveshare e-Paper](#waveshare-display-support) compatibility for more information.
- Picture Frame or 3D Stand
    - See [community.md](./docs/community.md) for 3D models, custom builds, and other submissions from the community

**Disclosure:** The links above are affiliate links. They may earn a commission from qualifying purchases, at no extra cost, which helps support maintenance and development for this project.
...
After the installation completes, the script will prompt a reboot of the Raspberry Pi. Once rebooted, the display will update to show the InkyPi splash screen.
...
For more details, including instructions on how to image the microSD with Raspberry Pi OS, refer to [installation.md](./docs/installation.md). It also helps to check out [this YouTube tutorial](https://youtu.be/L5PvQj1vfC4).
...
3. Run the update script with sudo:
    ...
    ```
This process ensures that any new updates, including additional dependencies, are applied properly without requiring a full reinstallation.
...
## Roadmap
The InkyPi project keeps moving forward, with more features and improvements planned for the future.
...
Check out the public [trello board](https://trello.com/b/SWJYWqe4/inkypi) to explore upcoming features and vote on what should come next.
...
Check out the [troubleshooting guide](./docs/troubleshooting.md). If issues remain, create an issue on the [GitHub Issues](https://github.com/fatihak/InkyPi/issues) page.

If a Pi Zero W is in use, note that there are known issues during the installation process. See the [Known Issues during Pi Zero W Installation](./docs/troubleshooting.md#known-issues-during-pi-zero-w-installation) section in the troubleshooting guide for additional details.
