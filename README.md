...
Check out the [troubleshooting guide](./docs/troubleshooting.md). If issues continue, open an issue on the [GitHub Issues](https://github.com/fatihak/InkyPi/issues) page.
