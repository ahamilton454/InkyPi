...
- The web interface lets the display update and configure from any device on the network
...
- Open source project that lets the community modify, customize, and create plugins
...
**Disclosure:** The links above are affiliate links. I may earn a commission from qualifying purchases made through them, at no extra cost, which helps support ongoing maintenance and development for this project.

## Installation
To install InkyPi, use the steps below:
...
After the installation completes, the script prompts for a Raspberry Pi reboot. Once the system reboots, the display updates to show the InkyPi splash screen.
...
## Update
To update InkyPi with the latest changes, use these steps:
...
## Roadmap
The InkyPi project continues to grow, with many exciting features and improvements planned for the future.
...
Check out the public [trello board](https://trello.com/b/SWJYWqe4/inkypi) to explore upcoming features and vote on what seems most helpful next.

## Waveshare Display Support

Waveshare offers a range of e-Paper displays, similar to the Inky screens from Pimoroni, with slightly different requirements. Inky displays auto-configure via the inky Python library, while Waveshare displays require model-specific drivers from their [Python EPD library](https://github.com/waveshareteam/e-Paper/tree/master/RaspberryPi_JetsonNano/python/lib/waveshare_epd).
...
Check out the [troubleshooting guide](./docs/troubleshooting.md). If trouble continues, feel free to create an issue on the [GitHub Issues](https://github.com/fatihak/InkyPi/issues) page.
...
These similar projects are worth exploring:
...
- [PiInk](https://github.com/tlstommy/PiInk) - provided inspiration for InkyPi's flask web ui
