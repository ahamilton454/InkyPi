...
- The Open-Meteo query requests temperatures in Celsius.
- The Weather plugin converts temperatures to Kelvin by adding `273.15`.
- In the weather display, daily minimum/maximum values do not include a degree symbol when `units` is `standard`.
